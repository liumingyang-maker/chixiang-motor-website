...
async function build() {
  ...
  await saveWorkbook('Phase_5_Landing_Page_Change_Log.xlsx', async wb => {
    const rows=[['Market','URL','Action','Product Direction','Evidence Boundary','Native Review','Ads Priority','Status'],
      ...
      ['Uzbekistan','/ru/uzbekistan/','New canonical page','150–250 water-cooled cargo; spares separate','Vehicle listing is not complete-engine demand or compatibility proof','Russian required; Uzbek CTA required','Priority design','IMPLEMENTED'],
      ['Russia','/ru/dvigatel-140/','New page','Lower horizontal 140 → Honda-style 140; CB/pit-bike research only','Platform names are context, not fit claims','Russian required','Priority design','IMPLEMENTED'],
  ...
  await saveWorkbook('Phase_5_Conversion_Map.xlsx', async wb => {
    const rows=[['Market','Page','Conversion Surface','Endpoint/Target','Trigger','Pre-success Conversion','Attribution','Phase 5 Test','Status'],
      ...
      ['Uzbekistan','/ru/uzbekistan/','B2B form','/api/contact','Server success required','Must not fire','market + source_form; shared attribution','Static only','PASS'],
      ['Uzbekistan','/ru/uzbekistan/','WhatsApp','wa.me/8619008225410','User click','N/A','Prefilled market message','Link only','PASS'],
      ['Russia','/ru/dvigatel-140/','B2B form','/api/contact','Server success required','Must not fire','market + source_form; shared attribution','Static only','PASS'],
      ['Russia','/ru/dvigatel-140/','WhatsApp','wa.me/8619008225410','User click','N/A','Prefilled market message','Link only','PASS'],
